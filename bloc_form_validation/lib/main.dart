import 'package:blocformvalidation/bloc/my_form_bloc.dart';
...
class _MyFormState extends State<MyForm> {
  ...
  bool _emailAutoValidator = false;
  bool _passwordAutoValidator = false;
      ...
      builder: (context, state) {
        if (state.formSubmittedSuccessfully) {
          return SuccessDialog(onDismissed: () {
            ...
            _emailAutoValidator = false;
            _passwordAutoValidator = false;
          });
        }
        return Form(
          child: Column(
            children: <Widget>[
              TextFormField(
                ...
                autovalidate: _emailAutoValidator,
                validator: (_) {
              ...
              TextFormField(
                ...
                obscureText: true,
                autovalidate: _passwordAutoValidator,
                validator: (_) {
